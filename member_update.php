...
<div class="container my-5">
    <div class="row me-2" style="display: flex; justify-content:center">
        <div class="col-lg-6">
            <div class="card" style="border-radius: 10px;">
                <div class="card-body" style="background-color: #ececdf; border-radius: 10px;">
                    ...
                    <form name="form1" onsubmit="checkForm(event)" novalidate style="position: relative;">
                        <div style="position: relative; text-align: center; height:180px; width:180px;"><img style="height:180px; width:180px;" src="./images/<?= $r['photo'] ?>" alt=""></div>
                        <div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" name="level">
                                    <option value="1" <?= $r['level'] == 1 ? 'selected' : '' ?>>一般會員</option>
                                    <option value="2" <?= $r['level'] == 2 ? 'selected' : '' ?>>尊榮會員</option>
                                </select>
                                <div class="form-text"></div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="file" class="form-label">修改照片</label>
